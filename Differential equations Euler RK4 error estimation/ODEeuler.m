%Function to compute dy/dt=-5y using Euler and compare it to the exact solution. Local error and global errors are
%plotted as well in the script called Comparision.m

function [localerr, globalerr] = ODEeuler(dt)
